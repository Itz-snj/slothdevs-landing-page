        ...
        >
          <div className="max-w-lg mx-auto">
            ...
            <p className="mt-4 max-w-lg text-base leading-relaxed text-muted-foreground">
              We're a small team. We want to show you what we have and hear what you think. No sales
              pitch, just a dev walking you through the code.
            </p>
            ...
            <p className="mt-6 font-mono text-xs text-muted-foreground">
              Or email directly:{" "}
              <a href="mailto:sumannareshclg@gmail.com" className="text-foreground underline">
                sumannareshclg@gmail.com
              </a>
            </p>
          </div>
        </motion.div>
