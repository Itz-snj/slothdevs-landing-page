    ...
    <footer className="px-6 py-10">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          <p className="font-mono text-6xl font-bold text-foreground tracking-tight">ENHANCE</p>
        </div>

        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 items-center border-t border-border pt-8">
          <div>
