      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-16 lg:grid-cols-2">
        ...
        >
          ...
          <div className="p-5 font-mono text-xs leading-relaxed text-muted-foreground">
            <p>
              <span className="text-foreground">$</span> sloth init --project acme-api
            </p>
            ...
            <p className="mt-3">
              <span className="text-foreground">$</span> sloth ops deploy --env staging
            </p>
            <p className="text-muted-foreground">
              → building container <span className="text-foreground">done</span> 1.2s
            </p>
            <p className="text-muted-foreground">
              → security scan <span className="text-foreground">pass</span> 0.8s
            </p>
            <p className="text-muted-foreground">
              → deploying to edge <span className="text-foreground">done</span> 3.1s
            </p>
            <p className="text-muted-foreground">
              → health check <span className="text-foreground">pass</span>
            </p>
            <p className="mt-3">
              <span className="text-foreground">$</span> <span className="animate-pulse">_</span>
            </p>
          </div>
        </motion.div>
      </div>
